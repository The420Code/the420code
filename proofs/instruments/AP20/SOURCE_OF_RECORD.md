...
present in the source. 10 front-matter item(s) — the paper's own
...
| | |
|---|---|
| Published PDF | `/AP20_The_Proof.pdf` |
| sha256 | `f9a21b1ed0528fa87311d400174bccaa5e8dddf70fd1ea0acb82cddf65483d3e` |
| Source of record | `AP20_The_Proof_FINAL_v3.docx` |
| Found in | Formatted |
| Paragraphs compared | 309 |
