# AP40 — source of record

**Verified 7 September 2026** by the paragraph-level test of record, adopted on
that date. Every source paragraph of 60 characters or more is present
in the published PDF, and every published sentence of 60 characters or more is
present in the source. 8 front-matter item(s) — the paper's own
...
| | |
|---|---|
| Published PDF | `/AP40_The_Irrational.pdf` |
| sha256 | `5b502ab0988ab10c89321fb877fce7704a237c1566e150bb35fa40934ceedcd8` |
| Source of record | `AP40_The_Irrational_FINAL_v3.docx` |
| Found in | Formatted |
| Paragraphs compared | 282 |
